...
object MenuIcons {
  ...
  val zoomExtends  = T(A(V(3.048,-1.855),V(-2.164,2.325),V(1.816,-3.041)),L(V(6.396,-5.332),V(5.165,-6.518)),L(V(5.165,-6.518),V(1.816,-3.041)),L(V(3.048,-1.855),V(6.396,-5.332)),L(V(2.475,8.035),V(0.267,10.243)),L(V(0.267,10.243),V(-1.94,8.035)),L(V(-1.94,8.035),V(2.475,8.035)),L(V(2.475,-8.035),V(0.267,-10.243)),L(V(0.267,-10.243),V(-1.94,-8.035)),L(V(-1.94,-8.035),V(2.475,-8.035)),L(V(-9.604,-0.1484),V(-7.397,-2.356)),L(V(-7.397,-2.356),V(-7.397,2.059)),L(V(-7.397,2.059),V(-9.604,-0.1484)),L(V(9.604,-0.1484),V(7.397,-2.356)),L(V(7.397,-2.356),V(7.397,2.059)),(L(V(7.397,2.059),V(9.604,-0.1484))))
  ...
  val connect = T(L(V(7.85,-8.63),V(7.85,9.09)),Q(V(7.85,-8.63),2.8),L(V(-8.95,-8.63),V(7.85,-8.63)))
